...
const Footer = () => {
  return (
    <footer className='bg-white col-center gap-32 pt-32 pb-4'>
      {/* col-center flex-col-reverse sm: */}
      <div className='flex-col-reverse sm:flex-row flex items-center justify-center h-[50em] sm:h-[20em] gap-0 sm:gap-16'>
        ...
        <Swiper
          ...
          slidesPerView={1}
          autoplay={{ delay: 3000 }}
          className='w-[26em] h-full sm:w-[18em] sm:h-[25em] rounded-2xl overflow-hidden'>
      ...
      <div className='col-center w-full'>
        <div className='flex justify-evenly [width:clamp(300px,100%,900px)] py-16'>
          {listData.map((data) => (
            <ul
              key={data.id}
