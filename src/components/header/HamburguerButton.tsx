  ...
  return (
    <>
      <div
        ...
        className='sm:hidden flex flex-col gap-1 cursor-pointer absolute -left-8 -top-2 z-[70]'
        onClick={openMenu}>
        <span
          id='line_a'
          className='relative w-8 h-1 bg-light-500 rounded-lg [transition:all_200ms] bg-purple-500'></span>
        <span
          id='line_b'
          className='relative w-8 h-1 bg-light-500 rounded-lg [transition:all_200ms] bg-purple-500'></span>
        <span
